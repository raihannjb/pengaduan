...
<div class="container">
  ...
  <ul>
    ...
    <li><a href="penilaian.php">Pengaduan</a></li>
    <li><a href="riwayat_nilai.php">Cek Pengaduan</a></li>
  </ul>
  </div>
  ...
  <div class="col-sm-9">
    <div class="card">
      <div class="card-body">
        ...
        <p style="color: black;" class="card-text">Selamat Datang di halaman dashboard, Silahkan ajukan pengaduan anda.<br><br></p>
      </div>
    </div>
  </div>
  </div>
